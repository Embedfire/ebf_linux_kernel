...
#define ILI9881C_LONG_COMMAND_INSTR(_cmd, _data1, _data2, _data3)		\
	{						\
		.op = ILI9881C_COMMAND,		\
		.arg = {				\
			.cmd = {			\
...
static const struct ili9881c_instr ili9881c_init[] = {
	...
	ILI9881C_LONG_COMMAND_INSTR(0xFF, 0x98, 0x81, 0x03),
	...
	ILI9881C_LONG_COMMAND_INSTR(0xFF, 0x98, 0x81, 0x04),
	...
	ILI9881C_LONG_COMMAND_INSTR(0xFF, 0x98, 0x81, 0x01),
	...
	ILI9881C_COMMAND_INSTR(0xA8, 0xAE),
	...
	ILI9881C_LONG_COMMAND_INSTR(0xFF, 0x98, 0x81, 0x00),
	ILI9881C_COMMAND_INSTR(0x11, 0x00),
...
static const struct drm_display_mode bananapi_default_mode = {
	.clock		= 66976, // clock-frequency
	.vrefresh	= 60,    // vertrefresh

	.hdisplay	= 800,   // hactive
	.hsync_start	= 800 + 24, // hactive + hsync-len
	.hsync_end	= 800 + 24 + 24, // hactive + hsync-len + hback-porch
	.htotal		= 800 + 24 + 24 + 12, // hactive + hsync-len + hback-porch + hfront-porch

	.vdisplay	= 1280, // vactive
	.vsync_start	= 1280 + 9, // vactive + vback-porch
	.vsync_end	= 1280 + 9 + 2, // vactive + vback-porch + vsync-len
	.vtotal		= 1280 + 9 + 2 + 7, // vactive + vback-porch + vsync-len + vfront-porch
};
